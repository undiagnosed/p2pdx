...
(function() {
  ...
  ContentHome = (function(superClass) {
    ...
    ContentHome.prototype.render = function() {
      ...
      return h("div#Content.center", [h("div.jumbotron", [h("div.container.text-center", [h("h1", "Welcome to p2pdx"), h("p", "Take action and help improve medical diagnostics by sharing your data."), h("a.btn.btn-primary.btn-lg", "Learn More")])]), h("div.container", [h("div.row", [h("div.col-md-3", [h("div.panel.panel-primary", [h("div.panel-heading", [h("h3.panel-title", "New Users")]), h("div.panel-body", [h("div.list-group", [h("a.list-group-item", "undiagnosed"), h("a.list-group-item", "yoman5000"), h("a.list-group-item", "fredsmith"), h("a.list-group-item", "alah"), h("a.list-group-item", "johnny")]), h("div.text-right", [h("a", "View All 500 Users ", [h("i.fa.fa-arrow-circle-right")])])])])]), h("div.col-md-3", [h("div.panel.panel-primary", [h("div.panel-heading", [h("h3.panel-title", "Top Tests")]), h("div.panel-body", [h("div.list-group", [h("a.list-group-item", "WBC"), h("a.list-group-item", "RBC"), h("a.list-group-item", "CD4 %"), h("a.list-group-item", "Lyme IgM"), h("a.list-group-item", "Quant IgG")]), h("div.text-right", [h("a", "View All 1200 Tests ", [h("i.fa.fa-arrow-circle-right")])])])])]), h("div.col-md-3", [h("div.panel.panel-primary", [h("div.panel-heading", [h("h3.panel-title", "Top Symptoms")]), h("div.panel-body", [h("div.list-group", [h("a.list-group-item", "Fatigue"), h("a.list-group-item", "Dry Mouth"), h("a.list-group-item", "Joint Pain"), h("a.list-group-item", "Headache"), h("a.list-group-item", "Muscle Pain")]), h("div.text-right", [h("a", "View All 250 Symptoms ", [h("i.fa.fa-arrow-circle-right")])])])])]), h("div.col-md-3", [h("div.panel.panel-primary", [h("div.panel-heading", [h("h3.panel-title", "Top Diagnoses")]), h("div.panel-body", [h("div.list-group", [h("a.list-group-item", "ME/CFS"), h("a.list-group-item", "Diabetes"), h("a.list-group-item", "Lupus"), h("a.list-group-item", "Cancer"), h("a.list-group-item", "Heart Disease")]), h("div.text-right", [h("a", "View All 120 Diagnoses ", [h("i.fa.fa-arrow-circle-right")])])])])])]), h("hr"), h("footer", [h("p", "This site currently served by ", this.num_peers, " peers, without any central server.")])])]);
    };
